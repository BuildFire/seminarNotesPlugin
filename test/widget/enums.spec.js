describe('Unit : seminarNotesPluginWidget content Enums', function () {
  ...
  describe('Enum : TAG_NAMES', function () {
    ...
    it('TAG_NAMES.SEMINAR_BOOKMARKS should exist and equals to seminarBookmarks', function () {
      expect(TAG_NAMES.SEMINAR_BOOKMARKS).toEqual("seminarBookmarks");
    });
    it('TAG_NAMES.SEMINAR_NOTES should exist and equals to seminarNotes', function () {
      expect(TAG_NAMES.SEMINAR_NOTES).toEqual("seminarNotes");
    });
  });
